		...
		?>
			...
			<div class="col-25">
				...
				if (isset($_POST["cmd"])) {
					...
					"
					<h4>Cart 
					<span class='price' style='color:pink'>
					...
					<div class="col-md-12">
						<div class="newsletter">
							...
							<ul class="newsletter-follow">
								<li>
									<a href=https://web.facebook.com/Adeaz-108423271621996"><i class="fa fa-facebook"></i></a>
								</li>
								<li>
									<a href="https://mobile.twitter.com/ADEaZ9"><i class="fa fa-twitter"></i></a>
								</li>
								<li>
									<a href=https://www.instagram.com/adeaz.c"><i class="fa fa-instagram"></i></a>
								</li>
								<li>
