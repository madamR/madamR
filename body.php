						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Dresses</a></li>
									<li><a data-toggle="tab" href="#ta1">Formal</a></li>
									<li><a data-toggle="tab" href="#tab1">Casual</a></li>
									<li><a data-toggle="tab" href="#tab1">Evening</a></li>
								</ul>
							</div>
						</div>
					</div>
                        ...
                        echo"
								...
								<div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$$pro_price.00</h4>
						...
						<div class="products-widget-slick" data-nav="#slick-nav-3">
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Brands</p>
										<h3 class="product-name"><a href="#">Adeas short Leggings</a></h3>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Brands</p>
										<h3 class="product-name"><a href="#">Adeas black bra and legging</a></h3>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Brands</p>
										<h3 class="product-name"><a href="#">Adeas red bra and Legging</a></h3>
										<h4 class="product-price">$70.00 </h4>
									</div>
								</div>
								<!-- product widget -->
						...
						<div class="products-widget-slick" data-nav="#slick-nav-4">
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Promos</p>
										<h3 class="product-name"><a href="#">New brand</a></h3>
										<h4 class="product-price">$70.00 </h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Offers</p>
										<h3 class="product-name"><a href="#">summer flex</a></h3>
										<h4 class="product-price">$70.00 </h4>
									</div>
								</div>
								<!-- product widget -->
							...
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">  
										<p class="product-category">Promos</p>
										<h3 class="product-name"><a href="#">Adeas Shirt</a></h3>
						...
						<div class="products-widget-slick" data-nav="#slick-nav-5">
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Brands</p>
										<h3 class="product-name"><a href="#">Two piece</a></h3>
										<h4 class="product-price">$70.00 </h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Brands</p>
										<h3 class="product-name"><a href="#">Adeas</a></h3>
										<h4 class="product-price">$70.00 </h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Brands</p>
										<h3 class="product-name"><a href="#">Adeas two piece</a></h3>
										<h4 class="product-price">$70.00 </h4>
									</div>
								</div>
								<!-- product widget -->
							...
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Brands</p>
										<h3 class="product-name"><a href="#">RED</a></h3>
										<h4 class="product-price">$70.00 </h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Brands</p>
										<h3 class="product-name"><a href="#">Adeas Bra</a></h3>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Offers</p>
										<h3 class="product-name"><a href="#">Black</a></h3>
										<h4 class="product-price">$70.00 </h4>
									</div>
								</div>
								<!-- product widget -->
